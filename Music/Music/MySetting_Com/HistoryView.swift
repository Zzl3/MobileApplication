...
//            .background(Color(""))
    ...
    //                    DetailView(animation: animation, album: selectedInstru, song: song, show: $showDetail)
                        NavigationLink(destination:
                                        DetailView(animation: animation, album: history.album, song: history.song, show: $ifshow)
                        ){
                            HStack {
                                Image(uiImage: UIImage.fetchImage(from: history.song.image))
                                    .resizable()
